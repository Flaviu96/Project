...
public class ProfileInfo extends javax.swing.JFrame {
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        MyThreadPool.getInstance().get().execute(new MainThread(15));
        //jDialog1.dispose();
    }//GEN-LAST:event_jLabel7MouseClicked

    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
       MyThreadPool.getInstance().get().execute(new MainThread(17));
    }//GEN-LAST:event_jPanel5MouseClicked

    private void jPanel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel11MouseClicked
        MyThreadPool.getInstance().get().execute(new MainThread(14));
